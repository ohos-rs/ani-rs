...
pub type ani_module = ani_class;
pub type ani_namespace = ani_class;
pub type ani_enum = ani_class;
...
pub struct __ani_interaction_api {
    ...
    pub Reference_Delete:
        ::std::option::Option<unsafe extern "C" fn(env: *mut ani_env, lref: ani_ref) -> ani_status>,
