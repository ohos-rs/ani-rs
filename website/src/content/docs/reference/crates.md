---
title: Workspace 结构
description: Rust crates、examples 与 pnpm website 包的职责和目录关系。
---
...
文档站作为根目录 pnpm workspace 中的独立包维护：

- Astro 负责构建与开发服务器
- Starlight 提供内容集合、导航、搜索友好结构和可访问性基础
- `website/src/content/docs/` 是唯一的文档内容源
- `website/src/styles/shadcn.css` 提供 shadcn 风格视觉层

常用命令和新增页面规则见 [文档站开发](/guide/website)。
